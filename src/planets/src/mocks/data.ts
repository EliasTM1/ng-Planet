const data : Planet[] = [
  ...
  },
  {
    ...
    overViewUrl: 'https://en.wikipedia.org/wiki/Venus',
    ...
    internalUrl: 'https://en.wikipedia.org/wiki/Venus#Internal_structure',
    ...
    surfaceUrl: 'https://en.wikipedia.org/wiki/Venus#Surface_geology',
    rotationTime: 243,
  ...
  },
  {
    ...
    internalUrl: 'https://en.wikipedia.org/wiki/Earth#Surface',
    ...
    surfaceUrl: 'https://en.wikipedia.org/wiki/Earth#Surface',
    rotationTime: 0.99,
  ...
  },
  {
    ...
    ,overViewUrl: 'https://en.wikipedia.org/wiki/Mars',
    internal: "Mars is a terrestrial planet whose surface consists of minerals containing silicon and oxygen, metals, and other elements that typically make up rock. The surface is primarily composed of tholeiitic basalt, although parts are more silica-rich than typical basalt.",
    internalUrl: 'https://en.wikipedia.org/wiki/Mars#Internal_structure',
    ...
    surfaceUrl: 'https://en.wikipedia.org/wiki/Mars#Surface_geology',
    rotationTime: 1.03,
    revolutionTime: 1.88,
    radius: 3389.5,
    averageTemp: -28,
  ...
  },
  {
    ...
    ,overViewUrl: 'https://en.wikipedia.org/wiki/Jupiter',
    ...
    internalUrl: 'https://en.wikipedia.org/wiki/Jupiter#Internal_structure',
    ...
    surfaceUrl: 'https://en.wikipedia.org/wiki/Jupiter#Great_Red_Spot_and_other_vortices',
    rotationTime: 9.93,
  ...
  },
  {
    ...
    ,overViewUrl: 'https://en.wikipedia.org/wiki/Saturn',
    ...
    internalUrl: 'https://en.wikipedia.org/wiki/Saturn#Internal_structure',
    ...
    surfaceUrl: 'https://en.wikipedia.org/wiki/Saturn#Atmosphere',
    rotationTime: 10.8,
    revolutionTime: 26.46,
    radius: 58232,
    averageTemp: -138,
    tempUnit: 'c'
  },
  {
    name: 'Uranus',
    overview: "Saturn is the sixth planet from the Sun and the second-largest in the Solar System, after Jupiter. It is a gas giant with an average radius of about nine and a half times that of Earth. It only has one-eighth the average density of Earth."
    ,overViewUrl: 'https://en.wikipedia.org/wiki/Uranus',
    ...
    internalUrl: 'https://en.wikipedia.org/wiki/Uranus#Internal_structure',
    ...
    surfaceUrl: 'https://en.wikipedia.org/wiki/Uranus#Atmosphere',
    rotationTime: 17.2,
    revolutionTime: 84,
    radius: 25362,
    averageTemp: -195,
  ...
  },
  {
    ...
    overViewUrl: 'https://en.wikipedia.org/wiki/Neptune',
    ...
    internalUrl: 'https://en.wikipedia.org/wiki/Neptune#Internal_structure',
    ...
    surfaceUrl: 'https://en.wikipedia.org/wiki/Neptune#Atmosphere',
    rotationTime: 16.08,
